       ...
       <el-table
           ...
           <el-table-column
             ...
             <template slot-scope="scope">
              <el-button type="success" icon="el-icon-check" circle style="zoom: 0.8;" :disabled="!tableData[rowID].isActive"></el-button>
               <el-button type="primary" icon="el-icon-edit" circle style="zoom: 0.8;left:34%;position:absolute;":disabled="tableData[rowID].isActive" ></el-button>
               </template>
           </el-table-column>
           <el-table-column
             label="操作"
             width="180">
             <template slot-scope="scope">
               <el-button @click="handleClickEdit(scope.row)" type="text" size="small" :disabled="!tableData[rowID].isActive" >预览</el-button>
...
<script>
  ...
  export default {
      created(){
          ...
          let parms={stuNumber:1953608,name:"吴英豪"}
          var data=new Object;
